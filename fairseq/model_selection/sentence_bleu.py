...
from .. import bleu, data, options, progress_bar, tasks, tokenizer, utils
...
def sentence_bleu(args):
    ...
    # TODO: Dump the BLEU score of each sentence into a new file.
    ...
    single_scorer = bleu.Scorer(tgt_dict.pad(), tgt_dict.eos(), tgt_dict.unk())
    bleu_list = [None for _ in range(len(task.dataset(args.gen_subset)))]
        ...
        for sample_id, src_tokens, target_tokens, hypos in translations:
            ...
            for i, hypo in enumerate(hypos[:min(len(hypos), args.nbest)]):
                ...
                if has_target and i == 0:
                    ...
                    single_scorer.add(target_tokens, hypo_tokens)

            bleu_list[sample_id] = single_scorer.score()
